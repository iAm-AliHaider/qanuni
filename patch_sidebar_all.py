...
# Add new nav items to appropriate sections

# Add Notifications + Analytics to Core section (after Tasks)
old_tasks = '{ href: "/tasks", label: t("nav.tasks"), icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },'
new_tasks = '''{ href: "/tasks", label: t("nav.tasks"), icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
...
f = f.replace(old_tasks, new_tasks)

# Add Templates + Audit to Insights section (after Settings)
old_settings = '{ href: "/settings", label: t("nav.settings"), icon:'
idx = f.find(old_settings)
if idx >= 0:
    # Find the end of this item (next },)
    end = f.find('},', idx) + 2
    old_line = f[idx:end]
    new_line = old_line + '''
