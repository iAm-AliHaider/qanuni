      ...
      <main className="p-3 md:p-6 max-w-6xl mx-auto space-y-4" id="report-content">
        {tab === "cases" && <>
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Cases by Status</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Cases by Type & Status</h3>
        ...
        {tab === "revenue" && <>
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Revenue by Lawyer</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Revenue by Client</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Monthly Revenue</h3>
        ...
        {tab === "utilization" && <>
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Lawyer Utilization</h3>
        ...
        {tab === "aging" && <>
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4">
            <h3 className="text-sm font-bold text-slate-800 mb-3">Invoice Aging Report</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-center"><p className="text-2xl font-bold text-emerald-600">{data.invoiceAging?.current || 0}</p><p className="text-[10px] text-emerald-700">Current</p></div>
              <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 text-center"><p className="text-2xl font-bold text-amber-600">{data.invoiceAging?.days_30 || 0}</p><p className="text-[10px] text-amber-700">30 Days</p></div>
              <div className="p-4 rounded-xl bg-orange-50 border border-orange-200 text-center"><p className="text-2xl font-bold text-orange-600">{data.invoiceAging?.days_60 || 0}</p><p className="text-[10px] text-orange-700">60 Days</p></div>
              <div className="p-4 rounded-xl bg-red-50 border border-red-200 text-center"><p className="text-2xl font-bold text-red-600">{data.invoiceAging?.days_90_plus || 0}</p><p className="text-[10px] text-red-700">90+ Days</p></div>
            </div>
          </div>
        </>}
      </main>
